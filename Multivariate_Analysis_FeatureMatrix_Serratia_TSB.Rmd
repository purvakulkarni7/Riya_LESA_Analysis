---
title: "Multivariate Analysis Steps for Feature Matrix Serratia TSB"
...
library(ggfortify)
autoplot(prcomp(df), data = data2Transformed, colour = 'Species', label  =TRUE, label.size = 3, loadings = TRUE, loadings.colour = 'dark gray', loadings.label = TRUE, loadings.label.size = 3, loadings.label.colour = 'Navyblue')
summary(prcomp(df))
```
